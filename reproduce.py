...
deltas = [["4W", "8W"], ["8W", "16W"], ["1D"], ["1D"]]
motifs = ["M3-0", "M3-1", "M4-0", "M4-1", "M4-2", "M4-3", "M4-4", "M4-5"]
        ...
        if RUN_STEMMING:
            ...
            for motif in motifs:
                if (graph == "sx-stackoverflow" and motif == "M4-1" and delta == "8W") or \
                    ...
                    max_trials = "1e9"
                elif (graph == "temporal-reddit-reply" and motif == "M3-2" and delta == "1D") or \
                    (graph == "temporal-reddit-reply" and motif == "M4-4" and delta == "1D"):
                    max_trials = "5e8"
                elif graph == "wiki-talk-temporal" and motif == "M4-0":
                    max_trials = "2e7"
                else:
                    max_trials = "1e8"
